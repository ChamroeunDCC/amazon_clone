...
const ProductCategory = () => {
    return ( 
        <div className="layout_main_relate_category d-flex p-3">
            <div className="inner_layout_relate_category d-flex">
                <div className="left_aside_relate_category">
                    <div className="inner_left_aside container">
                        <h6 className="fw-bold">Department</h6>
                        <ul>
                            <li><a href="">Toys & Games</a></li>
                            <li><a href="">Baby & Crafts Supplies</a></li>
                            <li><a href="">Building Toys</a></li>
                            <li><a href="">Dolls & Accessories</a></li>
                            <li><a href="">Kid's Dress Up & Pretend Play</a></li>
                            <li><a href="">Games & Acessories</a></li>
                            <li><a href="">Kid's Electronics</a></li>
                            <li><a href="">Learning & Education Toys</a></li>
                            <li><a href="">Novelty Toys & Amusements</a></li>
                            <li><a href="">Kid's Party Supplies</a></li>
                            <li><a href="">Puppets & Puppet Theaters</a></li>
                            <li><a href="">Puzzles</a></li>
                            <li><a href="">Hobby remote & App Controlled</a></li>
                            <li><a href="">Sports & Outdoor Play Toys</a></li>
                            <li><a href="">Toy Figures & Playsets</a></li>
                            <li><a href="">Tricycles, Scooters & Wagons</a></li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><a href="">Disney Princess</a></li>
                            <li><a href="">Little People</a></li>
                            <li><a href="">Lego Minifigures</a></li>
                        </ul>
                        ...
                        <div>
                            <form className="d-flex">
                                <input className="rounded ps-2" style={{width:'80px',fontSize:'14px'}} type="text" placeholder=" $Min"/>
                                <input className="rounded ps-2 ms-1" style={{width:'80px',fontSize:'14px'}} type="text" placeholder=" $Max"/>
                                <button type="button" style={{fontSize:'10px'}} className="btn btn-info rounded ps-2 pe-2 ms-2">Go</button>
                            </form>
                        </div>
