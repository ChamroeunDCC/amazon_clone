      ...
      <div id="nav_middle" className="w-100">
        <div className="search-bar">
          <div className="position-relative">
            <form>
              <button className="search_category p-1 pe-2 ps-2 border-0 rounded-start position-absolute dropdown-toggle top-50 start-0 translate-middle-y">
                All
              </button>
              <div className="btn-group">
                <button
                  style={{ fontSize: "12px" }}
                  className="search_category btn btn-secondary dropdown-toggle p-1 pe-2 ps-2 border-0 rounded-start position-absolute dropdown-toggle top-50 start-0 translate-middle-y"
                  type="button"
              ...
              <input
                style={{ fontSize: "14px" }}
                className="input_search rounded bg-white w-100"
                type="search"
                placeholder="Search Amazon"
              />
              <button
                type="button"
                className="btn_search rounded-end position-absolute top-50 end-0 translate-middle-y border-0"
              >
